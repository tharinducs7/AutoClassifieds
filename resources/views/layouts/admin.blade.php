        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ Auth::user()->profile_photo_url}}" class="wd-32 rounded-circle" alt="{{Auth::user()->name}}">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href=""><img src="{{ Auth::user()->profile_photo_url}}" class="wd-80 rounded-circle" alt="{{Auth::user()->name}}"></a>
              ...
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{ route('profile.show')}}"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
